...
class BaseModel(object):
    ...
    """
        ...
        with tf.compat.v1.name_scope('accuracy'):
            ...
            self.is_correct = tf.cast(is_correct, dtype=tf.float32)
    ...
    """
        ...
        lr = tf.Variable(learning_rate, name='learning_rate',
                         trainable=False)
        self.summaries.append(tf.raw_ops.ScalarSummary(tags=['learning_rate'], values=[lr]))
        ...
        # Summaries
        self.merged_summaries = tf.raw_ops.MergeSummary(inputs=[self.summaries])
