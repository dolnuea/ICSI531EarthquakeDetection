...
# todo do tfrecords instead of mseed
# creates fake data
def make_synthetic_data(templates_dir, trace_duration,
    ...
    for f in os.listdir(templates_dir):
        ...
        if os.path.isfile(f) and '.mseed' in f:
            ...
            print
            '  Sampling rate {} Hz'.format(sampling_rate)
            ...
            print
            "+ Converting back to {}".format(original_dtype)
            ...
            print
            '+ Generated {} events in {}s'.format(len(events), trace_duration)
            print
            '+ SNR on events windows: {:.1f} dB'.format(snr)
