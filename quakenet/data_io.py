...
Contains methods to load data of stream and catalogs"""
...
def load_stream(path):
    ...
    # Seismograms of various formats (e.g. SAC, MiniSEED, GSE2, SEISAN, Q, etc.) can be imported into a Stream object
